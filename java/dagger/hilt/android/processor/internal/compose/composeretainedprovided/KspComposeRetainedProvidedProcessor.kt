...
class KspComposeRetainedProvidedProcessor(
  environment: SymbolProcessorEnvironment,
) : KspBaseProcessingStepProcessor(environment) {

  @ExperimentalProcessingApi
  override protected fun processingStep() = ComposeRetainedProvidedProcessingStep(xProcessingEnv)

  /** Provides the {@link KspComposeRetainedProvidedProcessor}. */
